...
format: markdown
    ...
    *Descrizione:* Camere e suite eleganti, a volte con vista sulla cittÃ , in hotel esclusivocon piscina panoramica e spa.
    *Prezzo per notte:* â‚¬296 (prima delle tasse e spese: â‚¬260)
    *Prezzo totale:* â‚¬2,660 (prima delle tasse e spese: â‚¬2,336)
    ...
    *Servizi Inclusi:* Spa, Piscina, Parcheggio gratuito
    ...
    Descrizione: Hotel in stile Liberty con alloggi arredati in maniera artistica, ristoranteelegante, bar e spa.
    *Prezzo per notte:* â‚¬380 (prima delle tasse e spese: â‚¬333)
    *Prezzo totale:* â‚¬3,418 (prima delle tasse e spese: â‚¬3,000)
    *Check-in:* 15:00, Check-out: 12:00
    *Valutazione complessiva:* 4.5 su 5
    *Servizi Inclusi:* Spa, Piscina, Parcheggio gratuito
